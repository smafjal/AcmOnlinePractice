...
vi adj[MAX];
int idx[MAX],low[MAX],ind[MAX],outd[MAX],com[MAX];
int ti,components,N,M;
stack<int>S; int instack[MAX];
...
int SSC()
{
    mem(idx,0);mem(low,0);mem(ind,0);mem(outd,0);mem(com,0);mem(instack,0);
    components=0;ti=0;
