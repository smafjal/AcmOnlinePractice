...
void bfs(int start,int _end)
{
    FOR(i,0,N) sort(all(adj[arr[i]]));
    queue<int>Q;
    mem(col,0);mem(par,-1);
...
12
1 2 3 4 5 1 6 7 8 9 4 10
18
6 7 1 10 7 17 16 15 2 11 3 13 14 15 15 18 14 12
18
1 13 9 17 4 15 9 13 8 5 17 8 11 3 14 9 12 17
10
12 8 13 3 4 12 9 14 4 16
