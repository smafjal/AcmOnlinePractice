...
bool go(int num,int sum,int mask)
{
//    deb(num,sum);lookalike;
//    BINARY(mask);lookalike;

    if(num==5) return sum==23;
    bool fl=0;
...
int main()
{
    ...
    {
        if(a1==0 and a2==0 and a3==0 and a4==0 and a5==0) break;
        v.clear();

        v.pb(a1);v.pb(a2);v.pb(a3);v.pb(a4);v.pb(a5);
